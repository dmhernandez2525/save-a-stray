...
describe('Mongoose Models Schema Tests', () => {
  ...
  describe('WeightRecord Model', () => {
    ...
    it('should have recordedBy field with default empty string', () => {
      const schema = WeightRecord.schema.obj;
      expect(schema.recordedBy).toBeDefined();
      expect(schema.recordedBy.type).toBe(String);
      expect(schema.recordedBy.default).toBe('');
    });

    it('should have notes field with default empty string', () => {
      const schema = WeightRecord.schema.obj;
    ...
    it('should have recordedAt field with Date type', () => {
      const schema = WeightRecord.schema.obj;
