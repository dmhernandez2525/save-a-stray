...
class AdminPanel extends Component<AdminPanelProps, AdminPanelState> {
  ...
  render() {
    return (
      <div className="max-w-4xl mx-auto p-4 col-start-1 col-end-6 row-start-1 row-end-4 min-h-screen bg-background pb-20 md:pb-0">
        <h1 className="text-foreground font-capriola text-2xl sm:text-3xl mb-6 pt-4">Admin Dashboard</h1>
